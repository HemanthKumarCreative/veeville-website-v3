...
export const Footer: FC = () => {
  return (
    <footer className="w-full py-8 md:py-12 lg:py-16 flex-none border-t border-gray-200 mt-8 md:mt-12">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-12">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-[#848688] italic font-['Georgia'] text-[20px] sm:text-[24px] leading-relaxed">
              Veeville.
            </p>
          </div>
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1 flex justify-start sm:justify-center lg:justify-end">
